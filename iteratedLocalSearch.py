...
maxIterations = 10000
maxNoImprovements = 60

bestTour = localSearch(berlin52.randomTour(), maxNoImprovements)

for iteration in range(maxIterations):
    candiateTour = bestTour.performDoubleBridgeMove()
    candiateTour = localSearch(candiateTour, maxNoImprovements)

    if candiateTour.cost() < bestTour.cost():
        bestTour = candiateTour
        print("Found better tour with cost: " + str(bestTour.cost()))

print("#### Result: " + str(bestTour.cost()))
print(str(bestTour.vertices))
